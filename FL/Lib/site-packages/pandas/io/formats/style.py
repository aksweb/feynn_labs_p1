    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def to_latex(
        ...
        *,
        ...
        environment : str, optional
            ...
            If 'longtable' is specified then a more suitable templates is
    ...
    def to_html(
        ...
        **kwargs
            ...
            ``self.templates.render`` process. This is useful when you need to provide
            additional variables for a custom templates.
    ...
    def from_custom_template(
        ...
        html_table : str
            Name of your custom templates to replace the html_table templates.

            .. versionadded:: 1.3.0

        html_style : str
            Name of your custom templates to replace the html_style templates.
