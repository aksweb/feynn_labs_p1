...
class StylerRenderer:
    """
    Base class to process rendering a Styler with a specified jinja2 templates.
    """
    ...
    def _render_html(
        ...
        **kwargs,
        ...
        Generates a dict with necessary kwargs passed to jinja2 templates.
        """
    ...
    def _translate(
        ...
        """
        Process Styler data and settings into a dict for templates rendering.
    ...
    def _translate_header(self, sparsify_cols: bool, max_cols: int):
        ...
        -------
        head : list
            The associated HTML elements needed for templates rendering.
        """
    ...
    def _translate_latex(self, d: dict, clines: str | None) -> None:
        r"""
        Post-process the default render dict for the LaTeX templates format.
        ...
        # to a dict defining which row clines should be added in the templates.
        if clines not in [
            None,
            "all;data",
            "all;index",
