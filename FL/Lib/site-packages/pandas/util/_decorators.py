...
def doc(*docstrings: None | str | Callable, **params) -> Callable[[F], F]:
    ...
    callable to keep track the original docstring templates for potential usage.
    If it should be consider as a templates, it will be saved as a string.
    ...
    *docstrings : None, str, or callable
        The string / docstring / docstring templates to be appended in order
        after default docstring under callable.
    **params
        The string which would be used to format docstring templates.
    """
